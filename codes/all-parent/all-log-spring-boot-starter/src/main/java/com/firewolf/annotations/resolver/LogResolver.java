package com.firewolf.annotations.resolver;

import com.firewolf.annotations.LXLog;
...
public class LogResolver {
     ...
     * 切点
     */
    private final String EXECUTION = "@annotation(com.firewolf.annotations.LXLog)";
