...
public class ParamTestDriver {
    ...
    void testValueSourceStringParams(String str) {
        assertTrue(str == null || (str.length() < 7));
    }
     ...
     */
    @ParameterizedTest
    @MethodSource("com.firewolf.demo.test.simple.ParamTestDriver#provider")
    void testMethodParams(ChronoUnit chronoUnit) {
        assertTrue(Arrays.asList(ChronoUnit.HALF_DAYS, ChronoUnit.DAYS).contains(chronoUnit));
    }
