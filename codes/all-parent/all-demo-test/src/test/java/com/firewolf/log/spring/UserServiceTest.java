package com.firewolf.log.spring;

import com.firewolf.log.entity.User;
import com.firewolf.log.mybatis.UserMapper;
...
class UserServiceTest {
    ...
    void addUser() {
        ...
        String name = "myname";
        when(userMapper.selectCount(ArgumentMatchers.eq(User.builder().account(name).build()))).thenReturn(1);
