...
```shell
sudo ./sdc-upload-linux -k eyJpZCI6MjQzfQ.E2e6Dw.tCYxnVpNfzLIhh4bcxbEPISNlII -p EBG发布版本/盘古/test版本/主线版本/V1.1.0/V1.1.0.RC01/人数算法仓/   crowd-count_dev-6b38910c-build324307.tar.xz & 
...
scp -r core.classic-5.8-2021.01-patch1.ebg.devops_release_pkg security@10.122.101.7:/home/security/lxb
